class ObjectivesController < ApplicationController
  before_action :set_objective, only: [:show, :edit, :update, :destroy, :move]

  # GET /objectives
  # GET /objectives.json
  def index
    @objectives = Objective.sorted
  end
  ...
  def move
    @objective.insert_at(objective_params[:position].to_i)
    render action: :show
  end
  ...
  private
    ...
    def objective_params
      params.require(:objective).permit(:name, :position)
    end
end
